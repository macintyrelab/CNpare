...
The `CNpare_DemonstratingUtility` rmarkdown in the `vignettes` folder can be compiled to reproduce a typical workflow of the tool.
...
To compile these documents run knitr to html. Packages required to compile Rmarkdown documents include: knitr, dplyr, ggplot2, reshape2, data.table, flexmix, NMF, stats, splitstackshape, kableExtra and magrittr.
