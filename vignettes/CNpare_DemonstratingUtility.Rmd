...
For this example, we compare the copy-number profile of **KURAMOCHI** (our sample of interest) with the copy-number profiles of the cell line models. We use [*four similarity metrics*]{.ul}:
...
We aim at finding the cell line of the same tissue origin that represents the CIN type operating in **KURAMOCHI** (our sample of interest). We have selected this HGSO cancer cell line because it is known to have extreme CIN. Therefore, we selected profiles of all cell lines derived from ovary tissue.
